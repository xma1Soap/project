...
export type BillingSettings = {
  ...
  'checkin_setting.quota_threshold': number
}
...
export type OperationsSettings = {
  ...
  'test_penalty.enabled': boolean
  'test_penalty.min_prompt_tokens': number
  'test_penalty.penalty_quota': number
  'empty_response_billing.enabled': boolean
