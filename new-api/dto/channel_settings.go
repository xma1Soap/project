...
type ChannelSettings struct {
	...
	UseLocalPromptTokens   bool   `json:"use_local_prompt_tokens,omitempty"` // 使用本地计算的输入tokens而非上游返回值
	DisableTestPenalty     bool   `json:"disable_test_penalty,omitempty"`    // 禁用该渠道的测试惩罚
}
