...
export function DataTableView<TData>(props: DataTableViewProps<TData>) {
  ...
  return (
    <div
      className={cn(
        'bg-card supports-[backdrop-filter]:backdrop-blur-xl overflow-hidden rounded-lg border',
    ...
    <div className={props.tableContainerClassName}>
      <Table className={props.tableClassName} style={tableSizing.style}>
        ...
        <DataTableHeader
          ...
          className={cn(
            '[background-color:var(--table-header)] supports-[backdrop-filter]:backdrop-blur-md',
