...
func TestChannel(c *gin.Context) {
	...
	if result.localErr != nil {
		...
		addChannelTestErrorFields(resp, result.newAPIError)
...
// addChannelTestErrorFields exposes structured, non-secret error metadata for
// health controllers. Existing clients can ignore these additive fields.
func addChannelTestErrorFields(resp gin.H, newAPIError *types.NewAPIError) {
	if newAPIError == nil {
		return
	}
