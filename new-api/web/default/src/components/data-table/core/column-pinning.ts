...
function getPinnedColumnClassName(
  ...
  return cn(
    ...
    edgeClassName,
    kind === 'header'
      ? '[background-color:var(--table-header-bg,var(--table-header))] supports-[backdrop-filter]:backdrop-blur-md group-hover:[background-color:var(--table-header-hover)] z-30'
      : '[background-color:var(--table-row)] supports-[backdrop-filter]:backdrop-blur-md z-10 group-hover:[background-color:color-mix(in_oklch,var(--muted)_50%,var(--background))] group-data-[state=selected]:bg-muted',
