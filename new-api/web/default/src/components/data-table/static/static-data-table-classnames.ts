...
export const staticDataTableClassNames = {
  container:
    'bg-card overflow-hidden rounded-md border supports-[backdrop-filter]:backdrop-blur-xl',
  sectionContainer:
    'border-border/60 bg-card rounded-lg supports-[backdrop-filter]:backdrop-blur-xl',
  embeddedContainer: 'rounded-none border-0',
  compactTable: 'text-sm',
  compactHeaderRow: 'hover:bg-transparent',
  mutedHeaderRow:
    '[background-color:var(--table-header)] supports-[backdrop-filter]:backdrop-blur-md hover:[background-color:var(--table-header-hover)]',
  compactHeaderCell:
