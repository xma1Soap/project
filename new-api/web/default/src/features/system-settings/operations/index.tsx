...
const defaultOperationsSettings: OperationsSettings = {
  ...
  'test_penalty.enabled': false,
  'test_penalty.min_prompt_tokens': 0,
  'test_penalty.penalty_quota': 0,
  'empty_response_billing.enabled': false,
  'ua_blacklist.enabled': false,
  'ua_blacklist.keywords': [] as string[],
