...
export const channelFormSchema = z
  .object({
    ...
    use_local_prompt_tokens: z.boolean().optional(),
    disable_test_penalty: z.boolean().optional(),
...
export const CHANNEL_FORM_DEFAULT_VALUES: ChannelFormValues = {
  ...
  use_local_prompt_tokens: false,
  disable_test_penalty: false,
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        use_local_prompt_tokens: parsed.use_local_prompt_tokens || false,
        disable_test_penalty: parsed.disable_test_penalty || false,
      }
    } catch (error) {
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    use_local_prompt_tokens: formData.use_local_prompt_tokens || false,
    disable_test_penalty: formData.disable_test_penalty || false,
  }
