...
function hasAdvancedSettingsValues(values: ChannelFormValues): boolean {
  return Boolean(
    ...
    values.use_local_prompt_tokens ||
    values.disable_test_penalty ||
                  ...
                  >
                    ...
                    <div className={sideDrawerSectionClassName()}>
                      ...
                      <div className='divide-border space-y-0 divide-y border-y'>
                        ...
                        <FormField
                          control={form.control}
                          name='use_local_prompt_tokens'
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between px-4 py-3'>
                              <div className='space-y-0.5'>
                                <FormLabel>
                                  {t('Use Local Prompt Tokens')}
                                </FormLabel>
                                <FormDescription>
                                  {t(
                                    'Use locally estimated prompt tokens for billing instead of upstream usage.'
                                  )}
                                </FormDescription>
                              </div>
                              <FormControl>
                        ...
                        <FormField
                          control={form.control}
                          name='disable_test_penalty'
                          render={({ field }) => (
                            <FormItem className='flex items-center justify-between px-4 py-3'>
                              <div className='space-y-0.5'>
                                <FormLabel>
                                  {t('Disable Test Penalty')}
                                </FormLabel>
                                <FormDescription>
                                  {t(
                                    'Do not apply global test penalty billing to this channel.'
                                  )}
                                </FormDescription>
                              </div>
                              <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              {t(
                                'Reject requests whose estimated input tokens exceed this channel limit.'
                              )}
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
