...
*/
import { EmptyResponseBillingSection } from '../general/empty-response-billing-section'
import { SystemBehaviorSection } from '../general/system-behavior-section'
import { TestPenaltySection } from '../general/test-penalty-section'
import { UABlacklistSection } from '../general/ua-blacklist-section'
...
const OPERATIONS_SECTIONS = [
  ...
  {
    id: 'test-penalty',
    titleKey: 'Test Penalty',
    build: (settings: OperationsSettings) => (
      <TestPenaltySection
        defaultValues={{
          test_penalty: {
            enabled: settings['test_penalty.enabled'],
            min_prompt_tokens: settings['test_penalty.min_prompt_tokens'],
            penalty_quota: settings['test_penalty.penalty_quota'],
          },
        }}
      />
    ),
  ...
  {
    id: 'empty-response-billing',
    titleKey: 'Empty Response Billing',
    build: (settings: OperationsSettings) => (
      <EmptyResponseBillingSection
        defaultValues={{
          empty_response_billing: {
            enabled: settings['empty_response_billing.enabled'],
          },
        }}
      />
    ),
  },
  {
    ...
    build: (settings: OperationsSettings) => (
      <UABlacklistSection
        defaultValues={{
          'ua_blacklist.enabled': settings['ua_blacklist.enabled'],
          'ua_blacklist.keywords': settings['ua_blacklist.keywords'] ?? [],
        }}
      />
    ),
  },
