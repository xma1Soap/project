    ...
    >
      ...
      >
        <div
          ...
          className='bg-sidebar supports-[backdrop-filter]:backdrop-blur-xl group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1'
        >
          {children}
        </div>
      </div>
