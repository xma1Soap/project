...
func InitOptionMap() {
	...
	common.OptionMap["ChannelCooldownEnabled"] = strconv.FormatBool(setting.ChannelCooldownEnabled)
	common.OptionMap["ChannelCooldownSeconds"] = strconv.Itoa(setting.ChannelCooldownSeconds)
	common.OptionMap["TokenNameAuditEnabled"] = strconv.FormatBool(setting.TokenNameAuditEnabled)
	common.OptionMap["TokenNameAuditWhitelistTokens"] = setting.TokenNameAuditWhitelistTokens
	common.OptionMap["TokenNameAuditWhitelistUsers"] = setting.TokenNameAuditWhitelistUsers
	common.OptionMap["TokenNameAuditRules"] = setting.TokenNameAuditRulesJSON
	common.OptionMap["TokenNameAuditActions"] = setting.TokenNameAuditActionsJSON
	common.OptionMap["TokenNameAuditIncludeAdmins"] = strconv.FormatBool(setting.TokenNameAuditIncludeAdmins)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "ChannelCooldownEnabled":
			setting.ChannelCooldownEnabled = boolValue
		case "ChannelCooldownSeconds":
			setting.ChannelCooldownSeconds, _ = strconv.Atoi(value)
		case "TokenNameAuditEnabled":
			setting.TokenNameAuditEnabled = boolValue
		case "TokenNameAuditIncludeAdmins":
			setting.TokenNameAuditIncludeAdmins = boolValue
	...
	switch key {
	case "TokenNameAuditWhitelistTokens":
		setting.TokenNameAuditWhitelistTokens = value
		setting.InvalidateTokenNameAuditCache()
	case "TokenNameAuditWhitelistUsers":
		setting.TokenNameAuditWhitelistUsers = value
		setting.InvalidateTokenNameAuditCache()
	case "TokenNameAuditRules":
		setting.TokenNameAuditRulesJSON = value
		setting.InvalidateTokenNameAuditCache()
	case "TokenNameAuditActions":
		setting.TokenNameAuditActionsJSON = value
